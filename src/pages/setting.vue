  ...
  <div class="flex flex-col justify-center" style="overflow: hidden; width: 1400px">
    ...
    <div class="relative left-30">
      ...
      <q-select
        ...
        :options="realcomcar"
        style="width: 250px"
        class="inline-block relative left-60"
        label="Select a bus"
      >
      </q-select>
      <q-select
        v-model="compark"
        :options="rawcomparkoption"
        style="width: 250px"
        class="inline-block relative left-70"
    ...
    <div class="relative left-30" style="width: 100%">
      ...
      <div
        id="showpark"
        style="width: 1110px; height: 700px; vertical-align: top"
        class="relative inline-block left-0 mt-5"
      ></div>
      ...
      <div class="q-pa-md inline-block absolute right-5 top-113 h-8">
        <div
          class="q-gutter-md h-8 absolute right-45 bottom-40"
        ...
        >
          <q-list bordered separator style="height: 300px; overflow: scroll">
            <q-item
              clickable
              v-ripple
              v-for="(item, index) in parktobus[parkparkname]"
              :key="index"
              @click="chosepark(item)"
            >
      ...
      <span class="relative right-0 bottom-55 left-60">
        ...
        >
          <q-card class="bg-red text-white" style="width: 300px">
            ...
            <q-card-section class="q-pt-none"> 停车场或车辆不能为空 </q-card-section>
        ...
        >
          <q-card class="bg-red text-white" style="width: 300px">
            ...
            <q-card-section class="q-pt-none"> 预设或名称不能为空 </q-card-section>
        ...
        <q-btn
          ...
          icon-right="send"
          label="添加此方案"
          class="inline-block relative left-82"
          @click="upload()"
        />
      </span>
    </div>
  ...
  data() {
    return {
      ...
      parktobus: {
        ...
        西湖科技园: ["1-9705", "1-9513", "1-6031", "1-6034"],
        转塘公交停车场: [
          "7-9613",
          "7-9617",
          "7-9664",
        ...
        火车东站西: ["6-7921", "6-4219", "6-7926", "2-6513"],
        石桥公交停车场: [
          "6-7922",
          "3-9826",
          "3-9866",
        ...
        武林广场站: ["3-9347", "8-9082", "7-7014"],
        之江公交站: ["7-9025", "7-9066", "7-6041", "7-6036"],
        复兴路紫花路口: ["2-9056"],
        九和路公交停车场: [
          "8-9066",
          "8-9067",
        ...
        九福路公交站: ["2-4214", "2-4211", "2-4212", "2-4213", "2-4218"],
        塘萍路南: ["6-9481", "6-9594", "6-6053"],
        三里亭公交站: ["8-9813", "8-2005"],
        杭州汽车客运中心: [
          "2-4205",
          "2-4206",
          "2-4216",
        ...
        三福巷公交站: ["2-9842", "2-9893", "2-9894", "2-9897"],
        杭乔路公交站: [
          "2-9843",
          "2-9850",
          "2-9851",
        ...
        青城路公交站: ["3-9747", "3-9759", "3-9760", "3-9761"],
        火车东站东站: ["3-4202", "3-4206", "3-4211", "3-4212"],
        华丰停车场: ["8-2033"],
        丁城路公交站: ["8-7981", "8-7982", "8-7983", "8-7988", "8-7990"],
        长睦公交站: [
          "8-7991",
          "8-7992",
          "8-7993",
        ...
        公交六公司: ["7-9064", "7-9068", "7-9065", "7-9067", "7-6018"],
        紫霞街紫荆港路口: ["7-9069"],
        江东三路停车场: ["3-9159"],
        环北新村: ["6-9399", "6-9398", "6-9397", "6-9396", "6-9395", "6-9394"],
        农副产品物流中心: ["3-9239", "3-9249"],
        西湖科技园公交站: ["1-6032"],
        "拱北小区（途经站）": ["2-6036"],
        金色蓝庭公交站: ["1-9197"],
      },
